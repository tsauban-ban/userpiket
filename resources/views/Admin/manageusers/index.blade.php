        ...
        <form action="{{ route('manageusers.import') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                    ...
                    <p class="text-xs text-blue-600">Kolom: <span class="font-mono bg-blue-100 px-1 py-0.5 rounded">nama</span>, <span class="font-mono bg-blue-100 px-1 py-0.5 rounded">email</span>, <span class="font-mono bg-blue-100 px-1 py-0.5 rounded">divisi</span>, <span class="font-mono bg-blue-100 px-1 py-0.5 rounded">password</span> (opsional)</p>
                    <p class="text-xs text-blue-600 mt-1">Password default: <span class="font-mono">password123</span></p>
                </div>
                ...
                <div>
                    ...
                    <input type="file"
                           ...
                           accept=".xlsx,.xls,.csv"
                           required
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100">
                    <p class="text-xs text-gray-500 mt-1">Format: .xlsx, .xls, .csv (Max: 2MB)</p>
                </div>

                <!-- Download Template Link -->
                <div class="text-center">
                    <a href="{{ route('manageusers.template') }}" class="text-sm text-teal-600 hover:text-teal-700 hover:underline inline-flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
